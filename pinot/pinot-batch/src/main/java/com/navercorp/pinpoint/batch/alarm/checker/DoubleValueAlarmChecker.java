...
public class DoubleValueAlarmChecker extends PinotAlarmChecker<Double> {


    protected DoubleValueAlarmChecker(List<PinotAlarmRule> rules, String unit, PinotDataCollector dataCollector, AlarmCondition<Double> alarmCondition) {
    ...
    public String getCheckerType() {
        return DoubleValueAlarmChecker.class.getSimpleName();
    }
