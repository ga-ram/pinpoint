...
public class LongValueAlarmChecker extends PinotAlarmChecker<Long> {

    protected LongValueAlarmChecker(List<PinotAlarmRule> rules, String unit, PinotDataCollector<Long> dataCollector, AlarmCondition<Long> alarmCondition) {
