...
import com.navercorp.pinpoint.batch.alarm.sender.PinotAlarmMessageSender;
...
public class UriStatAlarmWriter implements ItemWriter<PinotAlarmCheckers>, StepExecutionListener {
    ...
    private final PinotAlarmMessageSender alarmMessageSender;
    private final PinotAlarmWriterInterceptor interceptor;
    private StepExecution stepExecution;

    public UriStatAlarmWriter(PinotAlarmMessageSender alarmMessageSender,
